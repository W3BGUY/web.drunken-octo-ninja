  ...
  <body>
    ...
    <div id="outter-container">
      <div id="inner-container">
        <div id="ad-intro">
          <p>In today's multi-channel social world, brand is king. S2G creates best-in-class U.S. based outsourced customer response solutions focused on differentiating our clients' brand. We become you. We immerse in your brand. Welcome to a new outsource experience. Are you ready?</p>
          <img src="./lib/img/logo.gif" alt="Support Services Group">
        </div>
        <div id="ad-content">
          <div id="ad-form">
            <section id="sidebar">
        ...
        <a href="home.php" id="continue">Continue to Support Services Group website &rarr;</a>
      </div>
      <div id="footer">
