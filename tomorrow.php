  ...
  <body>
    ...
    <div id="outter-container">
      <div id="inner-container">
        ...
        <div id="content">
          <div id="masthead">
            <h2>Built-to-Suit, Flexible Solutions<br />
              for the Technology of Tomorrow</h2>
          </div>
          <div id="main-content">
            <h3>Tomorrow</h3>
            <img src="lib/img/tomorrow-small.jpg" id="photo">
            <p>With 10 years of niche experience supporting only technology, consumer electronics, software and digital entertainment, S2G has the operational experience and expertise to assist in building support solutions for the technology of tomorrow. When building support solutions for the technology of tomorrow, why not pick a niche provider who can customize to your specific needs?</p>
            <p>S2G designs build-to-suit solutions for the products of tomorrow that include:</p> 
            <ul>
              ...
              <li>Training Curriculum, Labs, Support Processes, and Best Practices</li>
              <li>IVR, KDB, CRM, Self Service, tools and technology</li>
              <li>Certified Technicians (A+, C+, MCSE, etc.) as required</li>
            </ul>
            <a href="lib/media/Tomorrow-CaseStudy-1.pdf" class="case-study" target="_blank">View a Case Study</a>				
          </div>
          <div>
            <section id="sidebar">
